...
model = load_model("veg-3-main.h5")
model1=load_model("fruit-2-main3.h5")

#integrate the api to retrieve the data based on email
def check(email):
    url = "https://r92t3n4rpj.execute-api.us-east-2.amazonaws.com/plant2?email="+email
...
def afterreg():
    ...
    if('errorType' in check(x[1])):
        url = "https://ym7k7jvl44.execute-api.us-east-2.amazonaws.com/plant1?"+params
